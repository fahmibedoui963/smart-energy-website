...
const projectTypes = [
  { value: "raccorde", fr: "Raccordé au réseau (On-Grid) - Maison / Villa / Appartement", en: "Grid-connected (On-Grid) - House / Villa / Apartment" },
  { value: "raccorde-pro", fr: "Raccordé au réseau - Commerce / Usine / Tertiaire", en: "Grid-connected - Shop / Factory / Commercial" },
  { value: "isole", fr: "Site isolé (Off-Grid) - Ferme / Chalet / Site distant", en: "Off-grid (Off-Grid) - Farm / Chalet / Remote site" },
  ...
  { value: "hybride", fr: "Hybride Solaire + Batteries / Groupe", en: "Hybrid Solar + Batteries / Generator" },
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  ...
                  <button type="submit" className="w-full md:w-auto bg-green-600 text-white px-8 py-4 rounded-lg font-medium text-lg hover:bg-green-700 transition-colors">{t.submit}</button>
                </form>
              </div>
            </div>
          </div>
